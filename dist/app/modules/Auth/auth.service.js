...
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isUserExists = yield admin_model_1.adminModel.findOne({ email: payload.email });
    if (!isUserExists) {
    ...
    const jwtPayload = {
        ...
        firstName: isUserExists === null || isUserExists === void 0 ? void 0 : isUserExists.firstName,
        lastName: isUserExists === null || isUserExists === void 0 ? void 0 : isUserExists.lastName,
